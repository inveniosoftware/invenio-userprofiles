...
project = u'Invenio-UserProfiles'
...
html_theme_options = {
    ...
    'extra_nav_links': {
        'invenio-userprofiles@GitHub': 'http://github.com/inveniosoftware/invenio-userprofiles',
        'invenio-userprofiles@PyPI': 'http://pypi.python.org/pypi/invenio-userprofiles/',
    }
}
...
latex_documents = [
  (master_doc, 'invenio-userprofiles.tex', u'invenio-userprofiles Documentation',
   u'CERN', 'manual'),
]
